...
document.getElementById("myCanvas").style.borderColor="red";
	...
	function up()
	{
		if(ball_y >=5)
		{
		   ...
		   console.log("cuando se presione la flcha hacia arriba, x=" + ball_x + ", y=" + ball_y);
	...
	function left()
	{
		if(ball_x >5)
		{
			...
			console.log("la anchura de la imagen " + block_image_width);
			console.log("cuando se presione la flcha hacia la izquierda, x=" + ball_x +", y="+ball_y);
			canvas.remove(ball_obj);
			new_image();
		}
	}
